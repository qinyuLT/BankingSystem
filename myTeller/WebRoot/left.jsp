...
<%@page import="com.dc.DAO.MenuDAO"%>
...
.MM a:hover {
  ...
  <tr>
    <td width="182" valign="top"><div id="container">
      <h1 class="type"><a href="javascript:void(0)">功能业务</a></h1>
      <div class="content">
        ...
        MenuDAO menuDAO = new MenuDAO(loginBean);
        ResultSet rs = menuDAO.getResult();
        while(rs.next()) {
        name = rs.getString(1);
        path = rs.getString(2);
        %>
       
          <li><a href=<%=path %> target="main"><%=name %></a></li>
        <% 
           }
           menuDAO.closeConn();
        %>
