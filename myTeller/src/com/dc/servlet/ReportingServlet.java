...
public class ReportingServlet extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp)
		...
		String reportMessage  = "server_id=" + server_id + ";flow_no=" + flow_no
		...
		TellerWriteFlow flow = new TellerWriteFlow(flow_no, 0, card_id, guest_id, "-", "等待", day, server_id);
